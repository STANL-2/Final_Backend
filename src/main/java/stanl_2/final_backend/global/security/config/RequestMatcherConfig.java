...
public class RequestMatcherConfig {
    ...
    public static void configureRequestMatchers(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/v1/salesHistory/statistics/average").hasAnyRole("salesHistory-statistics-average-employee-post", "GOD", "DIRECTOR", "ADMIN", "EMPLOYEE")
                ...
                .requestMatchers(HttpMethod.POST, "/api/v1/salesHistory/statistics/best").hasAnyRole("salesHistory-best", "GOD", "DIRECTOR", "ADMIN", "EMPLOYEE")
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/salesHistory/employee/statistics/search/daily").hasAnyRole("salesHistory-employee-statistics-search-get", "GOD", "EMPLOYEE", "ADMIN")
