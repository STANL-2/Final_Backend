...
(
    ...
    FOREIGN KEY (ADMI_ID) REFERENCES tb_member (MEM_ID) ON DELETE CASCADE
);
...
INSERT INTO tb_contract (CONR_ID, CONR_TTL, CONR_CUST_NAME, CONR_CUST_IDEN_NO, CONR_CUST_ADR,
                         ...
                         MEM_ID, CENT_ID, CUST_ID, PROD_ID, ADMI_ID)
VALUES
-- 계약 1
('CON_000000001', '쏘렌토 계약', '박지훈', '880512-1234567', '서울특별시 강남구',
 ...
 'MEM_000000001', 'CEN_000000001', 'CUS_000000001', 'PRO_000000001', NULL),
...
('CON_000000002', '스포티지 계약', '김영희', '900123-2345678', '부산광역시 해운대구',
 ...
 'MEM_000000002', 'CEN_000000002', 'CUS_000000002', 'PRO_000000002', NULL),
...
('CON_000000003', 'K7 계약', '이철수', '950405-3456789', '대구광역시 수성구',
 ...
 'MEM_000000003', 'CEN_000000003', 'CUS_000000003', 'PRO_000000003', NULL),
...
('CON_000000004', '셀토스 계약', '박민준', '970512-4567890', '인천광역시 미추홀구',
 ...
 'MEM_000000004', 'CEN_000000004', 'CUS_000000004', 'PRO_000000004', NULL),
...
('CON_000000005', 'K3 계약', '최민수', '980618-5678901', '울산광역시 중구',
 ...
 'MEM_000000005', 'CEN_000000005', 'CUS_000000005', 'PRO_000000005', NULL),
...
('CON_000000006', '모하비 계약', '김민주', '850824-6789012', '대전광역시 서구',
 ...
 'MEM_000000006', 'CEN_000000006', 'CUS_000000006', 'PRO_000000006', NULL),
...
('CON_000000007', 'K8 계약', '정수영', '940705-7890123', '광주광역시 북구',
 ...
 'MEM_000000007', 'CEN_000000007', 'CUS_000000007', 'PRO_000000007', NULL),
...
('CON_000000008', '스팅어 계약', '이준호', '930910-8901234', '경기도 수원시',
 ...
 'MEM_000000008', 'CEN_000000008', 'CUS_000000008', 'PRO_000000008', NULL),
...
('CON_000000009', '니로 계약', '박소영', '890321-9012345', '충청북도 청주시',
 ...
 'MEM_000000009', 'CEN_000000009', 'CUS_000000009', 'PRO_000000009', NULL),
...
('CON_000000010', 'K5 계약', '김정훈', '900815-0123456', '전라북도 전주시',
 ...
 'MEM_000000010', 'CEN_000000010', 'CUS_000000010', 'PRO_000000010', NULL);
